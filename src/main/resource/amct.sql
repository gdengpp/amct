...
INSERT INTO `amct_left_menu` VALUES ('3', '图标管理', 'con', 'content/icon.jsp', '&#xe630;', '1', null, '1');
...
-- ----------------------------
INSERT INTO `amct_menu_monitor` VALUES ('4d9d27b5309f4465b7afb485916ab29d', '92e7f0838aa241f0be50ce4627b96021', '年龄', 'age', 'int', '4', '0');
INSERT INTO `amct_menu_monitor` VALUES ('7ab5210dea794719a0cb248d59c97a43', '92e7f0838aa241f0be50ce4627b96021', '邮箱', 'email', 'String', '32', '0');
INSERT INTO `amct_menu_monitor` VALUES ('beb778d51a6245b183e0f30dfc270f9a', '92e7f0838aa241f0be50ce4627b96021', '电话', 'iphone', 'String', '11', '0');
INSERT INTO `amct_menu_monitor` VALUES ('dc8b1e9d4f1c407cbc8360c667a6917c', '92e7f0838aa241f0be50ce4627b96021', '姓名', 'name', 'String', '32', '1');
INSERT INTO `amct_menu_monitor` VALUES ('ddbe13e1c5ae40a2a94030e065790965', '92e7f0838aa241f0be50ce4627b96021', '家庭住址', 'address', 'String', '128', '0');
...
INSERT INTO `amct_top_menu` VALUES ('92e7f0838aa241f0be50ce4627b96021', '用户管理', 'userinfo', 'menu\\userinfo.jsp', '1', '用于管理用户信息表');

-- ----------------------------
-- Table structure for amct_userinfo
-- ----------------------------
DROP TABLE IF EXISTS `amct_userinfo`;
CREATE TABLE `amct_userinfo` (
  `id` varchar(64) NOT NULL,
...
-- ----------------------------
-- Records of amct_userinfo
-- ----------------------------
INSERT INTO `amct_userinfo` VALUES ('1d6bd7c4-54a7-4fba-9c2f-5c57489c8728', '贵州贵阳', '18798477113', '1047267211@qq.com', '27', 'dengpp');
